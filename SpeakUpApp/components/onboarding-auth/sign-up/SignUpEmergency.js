...
const SignUpEmergency = ({navigation}) => {
  ...
  const onChangeEmergencyName = emergencyFullName =>
    setEmergencyFullName(emergencyFullName);
  const onChangeEmergencyPhone = emergencyPhoneNumber =>
    setEmergencyPhoneNumber(emergencyPhoneNumber);
  const onChangeEmergencyEmail = emergencyEmail =>
  ...
  const AlertWindow = () => {
    Alert.alert('Contact added', 'Press OK to add more', {
      text: 'OK',
      onPress: () => {
        clearInputs();
